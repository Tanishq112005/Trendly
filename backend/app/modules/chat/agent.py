...
class GraphManager:
    ...
    def _build_graph(self):
        ...
        self.builder.add_conditional_edges(
            START, self.check_exit, {"router_node": "router_node", END: END}
        )
        self.builder.add_conditional_edges(
            "router_node",
        ...
        self.builder.add_conditional_edges(
            "product_agent", tools_condition, {"tools": "tools", END: "guardrail"}
        )
        self.builder.add_conditional_edges(
            "ticket_agent", tools_condition, {"tools": "tools", END: "guardrail"}
        )

        self.builder.add_conditional_edges(
            "tools",
            self.route_after_router,
            {"product_agent": "product_agent", "ticket_agent": "ticket_agent"},
        )
