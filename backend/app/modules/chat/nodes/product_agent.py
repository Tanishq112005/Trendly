...
class ProductAgent:
    def __init__(self):
        ...
        self.tools = [OrderTools.lookup_order, OrderTools.check_return_eligibility, TicketTools.escalate_to_human]
...
1. You MUST ask for email/phone before looking up orders.
...
3. IMPORTANT (Sec 1.5): If an order is delayed >3 business days past its expected delivery, you must inform the user they qualify for a ₹250 store credit upon request.
